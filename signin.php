...
/* Eunjoo Na, 000811369
 * Date: 2020.12.08
 * Description: signin.php for the group scheduler web application. It gets the information of the signin from the user.
 */
?>
        ...
        <div class="col-lg-4">
            <div class="jumbotron" style="padding-top: 20px;">
                ...
                <form method="post" action="scheduler.php">
                    <h3 class="black" style="text-align: center; margin-top:25px;">SIGN IN</h3>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="ID" name="username" maxlength="20">
                    </div>
                    <div class="form-group">
